...
class LevelConfig:
    ...
    bg_tint:Tuple[int,int,int,int]=(0,0,0,0); score_bonus:int=100; score_threshold:int=500
...
LEVELS: list[LevelConfig] = [
    LevelConfig(1,"Training Grounds","1 opponent, full arena. Learn the ropes.",
        ...
        OrbConfig(3,9.0),(15,35,5,20),100,500),
    LevelConfig(2,"Floating Islands","2 opponents. L-shape — corners go first.",
        ...
        OrbConfig(3,8.0),(30,20,0,18),200,1000),
    LevelConfig(3,"Crumbling Bridges","3 opponents. Cross shape — hold the center.",
        ...
        OrbConfig(4,7.0),(40,10,10,22),350,1500),
    LevelConfig(4,"Shattered Platform","4 opponents. Ring arena — void center awaits.",
        ...
        OrbConfig(4,6.5),(60,10,0,30),550,2000),
    LevelConfig(5,"The Last Stand","5 opponents. Narrow bridges — no safe corners.",
        ...
        OrbConfig(5,5.5),(10,0,50,38),800,2500),
    LevelConfig(6,"Chaos Realm","6 opponents. Scattered islands — every step a gamble.",
        ...
        OrbConfig(5,5.0),(20,0,60,45),1100,3000),
    LevelConfig(7,"Nightmare","7 predators. Pure survival.",
        ...
        OrbConfig(6,4.5),(30,0,60,55),1500,3500),
    LevelConfig(8,"Abyss Depths","8 hunters. Ultimate challenge.",
        ArenaShape.RING,
        TileDifficulty(1.0,0.8,0.4,0.90,4,7,[10,20],0.8,True),
        AIProfile(8,1.30,0.12,75.0,0.90,110.0,True,7.0,3),
        HazardProfile(5.0,1.2,0.4,410.0,3.5,2.5,220.0,7,0.98),
        OrbConfig(6,4.0),(40,0,60,65),1800,4000),
    LevelConfig(9,"Endless Void","9 shadows. Survive the unknown.",
        ArenaShape.ISLANDS,
        TileDifficulty(0.8,0.6,0.3,0.89,4,8,[8,16],0.6,True),
        AIProfile(9,1.35,0.10,80.0,0.95,120.0,True,6.0,3),
        HazardProfile(4.0,1.0,0.3,430.0,3.0,2.0,230.0,8,0.98),
        OrbConfig(7,3.5),(50,0,60,75),2000,4500),
]
