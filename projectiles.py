...
_KIND_SETTINGS: dict[ProjectileKind, dict] = {
    ...
    ProjectileKind.SHURIKEN: {
        "speed": 320, "radius": 5, "color": (51, 51, 68),
        "glow": (140, 200, 255), "knockback": 200,
        "cooldown": 4.0, "lifetime": 1.2, "pierce": False,
        "spread_count": 2, "spread_deg": 14,
    },
    ProjectileKind.AXE: {
        "speed": 320, "radius": 8, "color": (200, 170, 80),
        "glow": (255, 220, 100), "knockback": 320,
        "cooldown": 3.0, "lifetime": 1.2, "pierce": False,
        "spread_count": 1, "spread_deg": 0,
    },
    ProjectileKind.ENERGY_BOLT: {
        "speed": 460, "radius": 8, "color": (255, 120, 30),
        "glow": (255, 180, 60), "knockback": 210,
        "cooldown": 3.0, "lifetime": 1.5, "pierce": True,
        "spread_count": 1, "spread_deg": 0,
    },
    ProjectileKind.ICE_SHARD: {
        "speed": 290, "radius": 8, "color": (140, 210, 255),
        "glow": (200, 240, 255), "knockback": 200,
        "cooldown": 3.0, "lifetime": 1.6, "pierce": False,
        "spread_count": 1, "spread_deg": 0,
        "freeze_on_hit": 0.8,
    },
    ProjectileKind.ENERGY_BULLET: {
        ...
        "cooldown": 3.0, "lifetime": 1.0, "pierce": False,
        "spread_count": 1, "spread_deg": 0,
    },
    ProjectileKind.SWORD_WAVE: {
        "speed": 400, "radius": 5, "color": (220, 60, 60),
        "glow": (255, 120, 80), "knockback": 280,
        "cooldown": 4.5, "lifetime": 0.8, "pierce": False,
