...
from settings import SOUND_POWER_CAVEMAN, SOUND_POWER_KNIGHT, SOUND_POWER_NINJA_DASH, SOUND_POWER_NINJA_END, SOUND_POWER_READY, SOUND_POWER_UNAVAILABLE, SOUND_POWER_WIZARD, SOUND_POWER_WIZARD_END
